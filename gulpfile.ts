...
// --------------
// Mobile.
gulp.task('build.mobile.prod', (done: any) =>
  runSequence('build.prod',
              'inject.icons',
              'build.sw',
              done));
...
// --------------
// Serve mobile.
gulp.task('serve.mobile.prod', (done: any) =>
  runSequence('build.mobile.prod',
              'server.prod',
              done));
...
// --------------
// Mobile Icons.
gulp.task('build.mobile.icons', (done: any) =>
  runSequence('build.mobile.icons.app',
          done));


// --------------
// Service Worker.
gulp.task('build.sw', (done: any) =>
  runSequence('build.serviceworker',
    done));
